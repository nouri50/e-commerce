...
if ($_POST) {
    ...
    if (!$verif_caractere || strlen($_POST['pseudo']) < 1 || strlen($_POST['pseudo']) > 20) {
        ...
        if ($utilisateur->num_rows > 0) {
            ...
            $_POST['mot de passe'] = password_hash($_POST['mot de passe'], PASSWORD_BCRYPT);
        }

        executeRequete("INSERT INTO utilisateur (pseudo, mot_de_passe, nom, prenom, email, civilite, ville, code_postal, adresse) VALUES ('$_POST[pseudo]', 
        '$_POST[mot_de_passe]', '$_POST[nom]',
         '$_POST[prenom]', '$_POST[email]', '$_POST[civilite]', '$_POST[ville]', '$_POST[code_postal]', '$_POST[adresse]')");
